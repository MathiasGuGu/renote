...
export interface User {
  ...
  export interface RollupValue {
    ...
    date?: DateValue | null;
    array?: Array<any>;
    function: 'count' | 'count_values' | 'count_unique_values' | 'count_all' | 'count_per_group' | 'percent_empty' | 'percent_not_empty' | 'sum' | 'average' | 'median' | 'min' | 'max' | 'range' | 'earliest_date' | 'latest_date' | 'date_range' | 'checked' | 'not_checked' | 'percent_checked' | 'percent_not_checked' | 'show_original' | 'show_unique';
  }
